...
\begin{itemize}
\item Code: \url{https://github.com/big-brain-zaru/FastMatrixF2}
\item Archive: \url{https://doi.org/10.5281/zenodo.22823114} (concept DOI, always resolving to the
latest version). The archive is this repository exactly; it holds the code, the per-instance logs, every
verified scheme and both papers.
